...
namespace beginner_image_blender
{
    public partial class Form1 : Form
    {
        ...
        {
            this.trackBarValue = trackBar1.Value;
            if (this.image_loaded)
            {
                ...
                BitmapData bmimg1 = this.image1.LockBits(new Rectangle(0, 0, this.image1.Width, this.image1.Height), ImageLockMode.ReadWrite, this.image1.PixelFormat);
                BitmapData bmimg2 = this.image2.LockBits(new Rectangle(0, 0, this.image2.Width, this.image2.Height), ImageLockMode.ReadWrite, this.image1.PixelFormat);
                BitmapData bmresult = this.result_Image.LockBits(new Rectangle(0, 0, this.image1.Width, this.image1.Height), ImageLockMode.ReadWrite, this.image1.PixelFormat);
                IntPtr scan0_1 = bmimg1.Scan0;
                IntPtr scan0_2 = bmimg2.Scan0;
                IntPtr scan0_3 = bmresult.Scan0;
                int length = Math.Abs(bmimg1.Stride) * this.image1.Height;
                ...
                this.image1.UnlockBits(bmimg1);
                this.image2.UnlockBits(bmimg2);
                this.result_Image.UnlockBits(bmresult);
                this.stopWatch1.Stop();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (this.image_loaded)
            {
                ...
                this.stopWatch1.Start();
                this.result_Image = new Bitmap(this.image1.Width, this.image1.Height);
                this.trackBarValue = (double)trackBar1.Value;
                this.stopWatch1.Reset();
                this.stopWatch1.Start();
                this.result_Image = new Bitmap(this.image1.Width, this.image1.Height);
                BitmapData bmimg1 = this.image1.LockBits(new Rectangle(0, 0, this.image1.Width, this.image1.Height), ImageLockMode.ReadWrite, this.image1.PixelFormat);
                ...
                Marshal.Copy(scan0_2, numArray2, 0, length);
                Marshal.Copy(scan0_3, numArray3, 0, length);
                Parallel.For(0, this.image1.Height, index1 => 
                {
                    ...
                    for(int index2 = 0; index2 < this.image1.Width * 3; index2 += 3)
                    {
                        ...
                        float num8 = (float)((this.trackBarValue * (double)num5 + (100.0 - this.trackBarValue) * (double)num2) / 100.0);
                        float num9 = (float)((this.trackBarValue * (double)num6 + (100.0 - this.trackBarValue) * (double)num3) / 100.0);
                        float num10 = (float)((this.trackBarValue * (double)num7 + (100.0 - this.trackBarValue) * (double)num4) / 100.0);
                        numArray3[index2 + num1] = (byte)num8;
                        numArray3[index2 + 1 + num1] = (byte)num9;
                        numArray3[index2 + 2 + num1] = (byte)num10;
                    }
